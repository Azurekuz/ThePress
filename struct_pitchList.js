class struct_pitchList{
    ...
    create(){
        ...
        this.pitchArray.push(new struct_story('003', this, "Hey boss! The story of the drunk biker who died got a lot of circulation around town, and the city just announced that they're shutting down the bikeshare system. What do you want to do? - ", [{sourceLabel:"City Police"}, {sourceLabel:'Victims Family'}, {sourceLabel:"Bike Makers"}], [1,3,5], 1));
        ...
        this.pitchArray.push(new struct_story('005', this, "Hey boss! So rumors have been floating around that the mayor and the Energy Company CEO have been secretly meeting in the town hall building. What do you want to do? - ", [{sourceLabel:"Mayor"}, {sourceLabel:'Energy CEO'}, {sourceLabel:"Social Media"}], [1,3,5], 1));
    ...
    initialStories(){
        this.availableStoryArray.push(this.pitchArray);
    }
